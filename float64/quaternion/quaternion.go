...
func (quat T) AlmostEqual(o T, tol float64) bool {
	return f64.AlmostEqual64(quat[0], o[0], tol) && f64.AlmostEqual64(quat[1], o[1], tol) && f64.AlmostEqual64(quat[2], o[2], tol) && f64.AlmostEqual64(quat[3], o[3], tol)
}
